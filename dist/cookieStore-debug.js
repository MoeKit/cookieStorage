define("moe/cookieStore/0.0.8/cookieStore-debug", [], function(require, exports, module) {
    var ObjProto = Object.prototype, hasOwnProperty = ObjProto.hasOwnProperty, isObject = function(obj) {
        return obj === Object(obj);
    }, has = function(obj, key) {
        return hasOwnProperty.call(obj, key);
    }, nativeKeys = Object.keys, getKeys = function(obj) {
    ...
    var CookieStorage = CookieStorage || function() {
        ...
        CookieManager = function() {
            ...
            set = function(name, value, option) {
                ...
                if (option.expires) {
                    var expires = new Date(+new Date() + option.expires * 24 * 60 * 60 * 1e3).toGMTString();
    ...
    var CookieStore = CookieStore || function() {
        ...
        CookieStore.prototype.persist = function() {
            var vCookieKey, vCookieVal, index = 0, vCookie = {}, store = this;
